<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"E:\webroot\gdbx\public/../application/admin\view\cms\block\edit.html";i:1534231760;s:58:"E:\webroot\gdbx\application\admin\view\layout\default.html";i:1533742466;s:55:"E:\webroot\gdbx\application\admin\view\common\meta.html";i:1533742466;s:57:"E:\webroot\gdbx\application\admin\view\common\script.html";i:1533742466;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-type" data-rule="required" class="form-control selectpage" data-source="cms/block/selectpage_type" placeholder="请手动输入或选择类型" data-primary-key="type" data-field="type" name="row[type]" type="text" value="<?php echo $row['type']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-url" data-rule="" class="form-control" name="row[url]" type="text" value="<?php echo $row['url']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-content" class="control-label col-xs-12 col-sm-2"><?php echo __('Content'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-content" data-rule="" class="form-control editor" rows="15" name="row[content]" cols="50"><?php echo $row['content']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
