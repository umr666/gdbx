<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"E:\webroot\gdbx\public/../application/admin\view\cms\archives\add.html";i:1534231760;s:58:"E:\webroot\gdbx\application\admin\view\layout\default.html";i:1533742466;s:55:"E:\webroot\gdbx\application\admin\view\common\meta.html";i:1533742466;s:57:"E:\webroot\gdbx\application\admin\view\common\script.html";i:1533742466;}*/ ?>
<!DOCTYPE html>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" data-rule="diyname" name="row[diyname]" class="form-control" placeholder="请输入自定义的名称,为空将使用主键ID" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="panel-body">
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="one">
                            ...
                            <div class="form-group">
                                <label for="c-status" class="control-label col-xs-12 col-sm-3"><?php echo __('Status'); ?>:</label>
                                <div class="col-xs-12 col-sm-8">
                                    <div class="radio">
                            ...
                            <div class="form-group">
                                <label for="c-status" class="control-label col-xs-12 col-sm-3"><?php echo __('Publish'); ?>:</label>
                                <div class="col-xs-12 col-sm-8">
                                    <div class='input-group date'>
                                        <input type='text' name="row[publishtime]" data-date-format="YYYY-MM-DD 00:00:00" value="<?php echo date('Y-m-d H:i:s'); ?>" class="form-control datetimepicker" />
