<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"E:\webroot\gdbx\public/../application/admin\view\cms\archives\edit.html";i:1534231760;s:58:"E:\webroot\gdbx\application\admin\view\layout\default.html";i:1533742466;s:55:"E:\webroot\gdbx\application\admin\view\common\meta.html";i:1533742466;s:57:"E:\webroot\gdbx\application\admin\view\common\script.html";i:1533742466;}*/ ?>
<!DOCTYPE html>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" data-rule="diyname" name="row[diyname]" class="form-control" placeholder="请输入自定义的名称,为空将使用主键ID" value="<?php echo $row['diyname']; ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
